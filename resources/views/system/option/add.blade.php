...
<head>
    ...
    <base href="http://laravel5-quangthinh91.c9users.io/public/templates/admin/minovate/">
                                    ...
                                    <div class="summary">
                                        ...
                                        <div class="media">
                                            <a class="pull-right" href="#">
                                                <span class="sparklineChart" values="5, 8, 3, 4, 6, 2, 1, 9, 7" sparkType="bar" sparkBarColor="#92424e" sparkBarWidth="6px" sparkHeight="36px">
                                                    Loading...</span>
                                            </a>
                                            <div class="media-body">
                                                This week sales
                                        ...
                                        <div class="media">
                                            <a class="pull-right" href="#">
                                                <span class="sparklineChart" values="2, 4, 5, 3, 8, 9, 7, 3, 5" sparkType="bar" sparkBarColor="#397193" sparkBarWidth="6px" sparkHeight="36px">
                                                    Loading...</span>
                                            </a>
                                            <div class="media-body">
                                                This week balance
                    ...
                    <div class="col-md-6">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-header dvd dvd-btm">
                                <h1 class="custom-font"><strong>Thêm mới</strong> {{ $modelInfo->vTableName }}</h1>
                                <ul class="controls">
                                    <li class="dropdown">
                            ...
                            <div class="tile-body">
                                ...
                                <form id="formAdd" class="form-horizontal" name="form4" role="form" method="POST" action="{{ $url->storePath }}">
                                    ...
                                    @endif @if($value->type =="longText")
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">{{ $value->vName }}</label>
                                        <div class="col-sm-9">
                                            <textarea name="{{ $value->name }}" cols="75" rows="10">{{Request::old($value->name)}}</textarea>
                                        </div>
                                    </div>
                                    @endif @if($value->type == "enum")
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">{{ $value->vName }}</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="{{ $value->name }}">
                                                @foreach($value->data as $va)
                                                <option value="{{ $va }}" @if(Request::old($value->name) == $va) selected="selected" @endif>{{ $va }}</option>
                                                @endforeach;
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <hr class="line-dashed line-full" /> @endforeach
                            ...
                            <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                <!-- SUBMIT BUTTON -->
                                <button type="submit" class="btn btn-default" id="form4Submit" form="formAdd">Submit</button>
                            </div>
                            <!-- /tile footer -->
